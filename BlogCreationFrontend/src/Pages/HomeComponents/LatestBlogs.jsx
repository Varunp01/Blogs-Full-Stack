...
const LatestBlogs = () => {
    const { blogs: latestBlogs, loading: blogLoading, error: blogError, refetch } = useBlogs({
        limit: 3,
        sort: "latest",
    });
    return (
        <>
            <section className="w-full bg-[#A5CFFF] px-4 py-16 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-6xl">
                    <div className="flex flex-col gap-6 border-b border-gray-200 pb-8 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-base text-gray-600 sm:text-lg">
                                Discover the latest articles from our readers.
                            </p>
                        </div>
                    ...
                    <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        {!blogLoading && !blogError && latestBlogs.length === 0 && <p className="text-gray-600">No featured blogs found.</p>}
